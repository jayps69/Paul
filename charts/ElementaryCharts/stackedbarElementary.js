document.addEventListener("DOMContentLoaded", function () {
    ...
    districtNumbers.forEach(function(districtNumber) {
        fetchDataFromPHP(districtNumber, 'stackedbarElementary_district' + districtNumber);
    });

    // Function to fetch data from the PHP script for a specific district
    function fetchDataFromPHP(value, canvasId) {
        var xhr = new XMLHttpRequest();
        xhr.open("POST", "../charts/ElementaryCharts/buttonclickstackedbar.php", true);
        ...
        const config = {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: ' ELEMENTARY TEACHERS IN DISTRICT ' + districtName,
                        font: {
                            size: 18,
                            weight: 'bold'
                        }
