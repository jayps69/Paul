document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchDataFromPHP() {
        ...
        xhr.open('GET', 'charts/DivisionCharts/schoolcount4.php', true); // Replace 'your_php_script.php' with the path to your PHP script
        ...
        const config = {
            ...
            options: {
                plugins: {
                    title: {
                        display: true,
                        text: 'DISTRICT IV SCHOOLS' // Your desired title here
                    },
                    tooltip: {
                        callbacks: {
                            ...
                            afterLabel: function(context) {
                                if (context.dataIndex === 0) {
                                    return 'Total Elementary: ' + elementarySum, 'Total School in DISTRICT IV: '  + overallTotal ;
                                   
                                } else if (context.dataIndex === 1) {
                                    return 'Total High School: ' + highSchoolSum, 'Total School in DISTRICT IV: '  + overallTotal ;
                                    
                                } else if (context.dataIndex === 2) {
                                    return 'Total SHS: ' + shsSum, 'Total School in DISTRICT IV: ' + overallTotal;
